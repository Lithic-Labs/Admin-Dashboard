...
<div style="background-color: black;">              
          <div class="wrapper" >
                ...
                <div class="row d-flex justify-content-center align-items-center"><h2 style="margin-bottom:20px;font-weight:bold;text-align:center;margin-top:10px;color: #fff;">SIGN IN</h2></div>
                <div class="card">
                    ...
                    <div class="card-action">
                        <button class="btn" type="submit" style="background-color: #21d575;color: #fff;">LOGIN</button>               
    ...
    const submitForm = async () => {
      if(validatedForm()){
        return await instance.post('/login',form).then((res) => {          
            ...
            localStorage.setItem("adminportalauthid",res.data.data.data.id);
            // clear form
            form.email = '';
            form.password ='';
